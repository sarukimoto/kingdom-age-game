...
function init()
  ...
  powersListTopButton = modules.client_topmenu.addRightGameToggleButton('powersListTopButton', tr('Powers') .. ' (Ctrl+Shift+P)', 'ka_game_powerslist', toggle)
  powersListTopButton:setOn(true)

  powersListWindow = g_ui.loadUI('ka_game_powerslist', modules.game_interface.getRightPanel())
...
function getPowerButton(id)
  return id and powerButtonsByIdList[id] or nil
end
