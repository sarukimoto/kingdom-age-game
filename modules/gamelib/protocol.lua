...
GameServerOpcodes = {
    ...
    GameServerInstanceInfo              = 52, -- Lua Opcode
    GameServerBlinkHit                  = 53, -- Lua Opcode
    GameServerCreatureColor             = 54,
    GameServerPlayerLockWalk            = 55,
    GameServerCreatureNickname          = 56,
    GameServerPlayerLoginname           = 57,
    GameServerLootWindow                = 58, -- Lua Opcode
    GameServerScreenImage               = 59, -- Lua Opcode
    GameServerCustomBox                 = 60, -- Lua Opcode
    -- 61 - Free to use
    GameServerCreatureSpecialIcon       = 62,
    GameServerAudio                     = 63,
    GameServerUnjustifiedPoints         = 64, -- Lua Opcode
    GameServerAttributesList            = 65,
    GameServerPowersList                = 66,
    ...
    --GameServerRuleViolationChannel      = 174, -- Deprecated
    --GameServerRuleViolationRemove       = 175, -- Deprecated
    --GameServerRuleViolationCancel       = 176, -- Deprecated
    --GameServerRuleViolationLock         = 177, -- Deprecated
    ...
    GameServerQuestLog                  = 229, -- Lua Opcode
    GameServerBugReport                 = 230, -- Lua Opcode
    GameServerRuleViolation             = 231, -- Lua Opcode
...
ClientOpcodes = {
    ...
    -- NOTE: add any custom opcodes in this range
    -- 51 - 99
    ClientGameLanguage                  = 52, -- Lua Opcode
    ClientUnjustifiedPoints             = 53, -- Lua Opcode
    ClientCustomBox                     = 54, -- Lua Opcode
    ClientAction                        = 55, -- Lua Opcode
    -- 56 - Free to use
    ClientAttribute                     = 57, -- Lua Opcode
    ClientPower                         = 58, -- Lua Opcode
    ...
    ClientAddVip                        = 220,
    ClientRemoveVip                     = 221,
    ClientQuestLog                      = 229, -- Lua Opcode
    ClientBugReport                     = 230, -- Lua Opcode
    ClientRuleViolation                 = 231, -- Lua Opcode
